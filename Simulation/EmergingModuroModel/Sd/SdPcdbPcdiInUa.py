...
class SdPcdbPcdiInUa(ModelConfig):
    ...
    def _createCellTypes(self):
        ...
        self.basalNecrosisProb = basal.necrosisProb = 0.000005
        ...
        self.intermediateNecrosisProb = intermediate.necrosisProb = 0.000005

        umbrella = Umbrellacell
        umbrella.setGrowthVolumePerDayRelVolume(0.07)
        umbrella.apoptosisTimeInDays = 70000000.0
        self.umbrellaNecrosisProb = umbrella.necrosisProb = 0.00002
