...
class SdCdbIpaInUa(ModelConfig):
    ...
    def _createCellTypes(self):
        ...
        intermediate.setDescendants(0.90, [intermediate.id, umbrella.id])
        intermediate.setDescendants(0.05, [intermediate.id, intermediate.id])
        intermediate.setDescendants(0.05, [umbrella.id, umbrella.id])
